...
def print_pck_analysis (total, file_output):
   ...
   for x in range(0,len(D)):
      if x % 2 == 0:
         ...
         print  >> file_output, 'Pck Mean Received Bits: ', (D[x] - TCP_encap_length * pck_r_s[x]) / total
      else:
         print  >> file_output, 'DASH 6mps'
         print  >> file_output, 'Pck Mean Received Bits: ', (D[x] - TCP_encap_length * pck_r_s[x + 18]) / total
   for x in range(0,len(T)):
      if x % 2 == 0:
         print  >> file_output, 'TCP 3mps'
         print  >> file_output, 'Pck Mean Received Bits: ', (T[x] - TCP_encap_length * pck_r_s[x + 6]) / total
      else:
         print  >> file_output, 'TCP 6mps'
         print  >> file_output, 'Pck Mean Received Bits: ', (T[x] - TCP_encap_length * pck_r_s[x + 24]) / total
   for x in range(0,len(U)):
      if x % 2 == 0:
         print  >> file_output, 'UDP 3mps'
         print  >> file_output, 'Pck Mean Received Bits: ', (U[x] - UDP_encap_length * pck_r_s[x + 12]) / total
      else:
         print  >> file_output, 'UDP 6mps'
         print  >> file_output, 'Pck Mean Received Bits: ', (U[x] - UDP_encap_length * pck_r_s[x + 30]) / total
